...
const folders = [
    ...
    },
    {
        ...
        folderName: "mappers",
        files: [
            { name: `${schemaName}.mapper`, ref: `domain.mapper`, ext: ".js" }
        ]
    },
    ...
    },
    {
        ...
        files: [
            ...
            { name: "index", ref: "index.environments", ext: ".js" },
    ...
    //SERVICES
    {
        ...
        files: [
           // { name: "base.service", ref: "base.service", ext: ".js" },
            { name: "index", ref: "index.services", ext: ".js" },
...
//NO FOLDER
    ...
    ,
    {
        ...
        folderName: null,
        files: [
            { name: "database", ref: "database", ext: ".js" },
